...
public enum TokenErrorResult implements BaseErrorCode {
    ...
    ACCESS_TOKEN_NOT_FOUND(HttpStatus.NOT_FOUND, "404", "해당 유저 ID의 액세스 토큰이 없습니다."),
    INVALID_REQUEST(HttpStatus.BAD_REQUEST, "400", "잘못된 토큰 요청입니다."),
    BLACKLISTED_TOKEN(HttpStatus.FORBIDDEN, "403", "블랙리스트에 등록된 토큰입니다. 다시 로그인해 주세요."),
    EXPIRED_AUTH_TOKEN(HttpStatus.UNAUTHORIZED, "401", "소셜 인증 토큰이 만료되었습니다. 다시 로그인해 주세요."),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "500", "서버 내부 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.");
